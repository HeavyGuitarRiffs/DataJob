...
const pieColors = ['#000000', '#22c55e', '#ffc0cb'];
const pieLabels = ['Men', 'Women', 'College Kids'];
...
export default function AgeSalaryPage() {
  ...
  return (
    <NavbarWithSidebar>
      ...
      <h1 className="text-2xl font-bold neon text-center">Gender Pay Gap Dashboard</h1>
        ...
        <div className="flex gap-8 items-start flex-wrap lg:flex-nowrap">
          <div className="space-y-4 w-full max-w-xs neon p-4 rounded-xl bg-white dark:bg-gray-800">
            <div>
          ...
          <aside className="max-w-sm text-sm leading-relaxed neon p-4 rounded-xl bg-white dark:bg-gray-800">
            ...
            <p>
              ...
              <br />There are 9 year old YouTube millionaires, and veterans working til they are past 90.
            </p>
            <br />Age and Income. Inconsequential.
          </aside>
        </div>

        <div className="flex gap-2 mt-4">
          <Button className="neon" variant={chartType === 'bar' ? 'default' : 'outline'} onClick={() => setChartType('bar')}>Bar</Button>
          <Button className="neon" variant={chartType === 'line' ? 'default' : 'outline'} onClick={() => setChartType('line')}>Line</Button>
          <Button className="neon" variant={chartType === 'pie' ? 'default' : 'outline'} onClick={() => setChartType('pie')}>Pie</Button>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow p-4 neon">
