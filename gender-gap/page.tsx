...
import { Chatbox } from "@/components/Chatbox";
      ...
      export default function GenderGapPage() {
        <div className="p-4">
        <h1 className="text-xl font-bold">Gender Pay Gap</h1>
        <p>Analyze the gender gap in salaries.</p>
      </div>
        const {
              ...
              <div className="flex gap-8 items-start flex-wrap lg:flex-nowrap">
                ...
                <aside className="max-w-sm text-sm leading-relaxed">
                  ...
                  <p>
                    ...
                    <br></br>
                           Men more likely than women to use AI at work? Anyone can work anywhere!    </p>
                </aside>
              </div>
