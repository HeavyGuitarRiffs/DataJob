...
export default function TopEarningsPage() {
  const {
  ...
  return (
    <NavbarWithSidebar>
      <div className="p-6 space-y-6">
        <h1 className="text-2xl font-bold">Top Earnings Dashboard</h1>
        ...
        <div className="flex gap-8 items-start flex-wrap lg:flex-nowrap">
          ...
          <aside className="max-w-sm text-sm leading-relaxed">
            ...
            <p>
              ...
              <br></br>
              Top jobs currently rank from YouTubers to Software Developers, SaaS, and Content Creators
            </p>
          </aside>
        </div>
