'use client';
    ...
    export default function CertificationsPage() {
      <div className="p-4">
        <h1 className="text-xl font-bold">Geography</h1>
        <p>See how location affects income and opportunities.</p>
      </div>
      const {
      ...
      return (
        <NavbarWithSidebar>
          <div className="p-6 space-y-6">
            <h1 className="text-2xl font-bold">Certifications Dashboard</h1>
            ...
            <div className="flex gap-8 items-start flex-wrap lg:flex-nowrap">
              ...
              <aside className="max-w-sm text-sm leading-relaxed">
                ...
                <p>
                  ...
                  <br></br>
                         Top growing locations for employment are Japan, Phillipines, USA, and Asia       </p>
              </aside>
            </div>
