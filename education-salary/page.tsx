  ...
  import { Chatbox } from "@/components/Chatbox";
          ...
          export default function EducationSalaryPage() {
            <div className="p-4">
        <h1 className="text-xl font-bold">Education & Salary</h1>
        <p>Correlation between education and earnings.</p>
      </div>
            const {
            ...
            return (
              <NavbarWithSidebar>
                <div className="p-6 space-y-6">
                  <h1 className="text-2xl font-bold">Gender Pay Gap Dashboard</h1>
                  ...
                  <div className="flex gap-8 items-start flex-wrap lg:flex-nowrap">
                    ...
                    <aside className="max-w-sm text-sm leading-relaxed">
                      ...
                      <p>
                        ...
                        <br></br>
                               Doctors and Lawyers always needed. School too    </p>
                               <br></br> An age of convenience in technology and AI is berthed before us. There are many ways to learn and earn
                    </aside>
                  </div>
